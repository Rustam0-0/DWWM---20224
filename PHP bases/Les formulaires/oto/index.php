...
<body class="body">
    ...
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
        ...
        <div class="form-row justify-content-between">
            <div class="col-3">
                <input class="col-3" type="radio" value="part" name="part_prof" id="part_ou_prof" <?php if ($part_ou_prof == 'part') : echo 'checked';
                                                                                                    endif; ?>>Particulier</input>
            </div>
            <div class="col-3">
                <input class="col-3" type="radio" value="prof" name="part_prof" id="part_ou_prof" <?php if ($part_ou_prof == 'prof') : echo 'checked';
                                                                                                    endif; ?>>Professionel</input>
            </div>
            <div class="col-3">
                <?php
                if ($update == true) :
    ...
    <table class="table">
        ...
        while ($row = $result->fetch_assoc()) : ?>
            <tr>
                ...
                <td>
                    <a href="index.php?edit=<?php echo $row['client_id']; ?>" class="btn btn-info">Editer</a>
                    <a href="index.php?delete=<?php echo $row['client_id']; ?>" class="btn btn-danger">Supprimer</a>
                </td>
            </tr>
        <?php endwhile; ?>
    </table>
